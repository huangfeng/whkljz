...
function $UrlRouterProvider(  $urlMatcherFactory) {
   ...
   * @example
   * <pre>
   * var app = angular-1.0.8.module('app', ['ui.router.router']);
   *
  ...
  this.$get =
    ...
    function ($location,   $rootScope,   $injector) {
      ...
      return {
         ...
         * @example
         * <pre>
         * angular-1.0.8.module('app', ['ui.router']);
...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory,           $locationProvider) {
   ...
   *       views = parent(state);
   *
   *   angular-1.0.8.forEach(view, function (config, name) {
  ...
  function $get(   $rootScope,   $q,   $view,   $injector,   $resolve,   $stateParams,   $location,   $urlRouter) {
     ...
     * @example
     * <pre>
     * var app angular-1.0.8.module('app', ['ui.router.state']);
     *
...
function $RouteProvider(  $stateProvider,    $urlRouterProvider) {
   ...
   * object has the same interface the angular-1.0.8 core route definition object has.
   * 
   * @example
   * <pre>
   * var app = angular-1.0.8.module('app', ['ui.router.compat']);
   *
   ...
   * control over all the stuff you would actually get from angular-1.0.8's core `$route`
   * service.
   */
  this.$get = $get;
